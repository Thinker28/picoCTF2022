...
</p>After going through a few, FUN_001015ac seems interesting.```ruby
require 'redcarpet'
markdown = Redcarpet.new("Hello World!")
puts markdown.to_html
```
as if it were checking if that (row, col) is valid. Checking, if it's a wall and if it's in bounds. We can now assume, that we need to edit the return value to true always, to be able to go through walls and get through parts we normally couldn't go through. 
