...
</p>After going through a few, FUN_001015ac seems interesting, as if it were checking if that (row, col) is valid. Checking, if it's a wall and if it's in bounds.
